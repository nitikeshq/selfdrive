...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen">
      ...
      <LocalBusinessSchema />
      {/* Hero Section */}
      <section className="relative min-h-[70vh] md:min-h-[80vh] flex items-center py-12 md:py-0">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full mt-20 sm:mt-16 md:mt-12 lg:mt-0">
